    ...
    render() {
        ...
        return (
                    <tr className='MobileClientInfo'>
                        ...
                        <td>
                            <input type='button' className='buttonEdit' value='Редактировать'  onClick={this.editClient}/>
                        </td>
                        <td>
                            <input type='button' className='buttonDelete' value='Удалить'  onClick={this.deleteClient}/>
                        </td>
                    </tr>
